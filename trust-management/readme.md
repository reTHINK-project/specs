...
Despite the emphasis of this protocol being in the mutual authentication it also supports anonymous communication, where the user who initiates the call starts it in anonymous mode. The only difference in the protocol flow is that the user who starts the communications do not send his identity assertion, making impossible for the user who receives the request for communication to verify his identity. The decision of accepting or not the anonymous communication rests with the policy engine
