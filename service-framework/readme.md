...
An initial description of the QoS support is provided [here](https://github.com/reTHINK-project/specs/tree/master/qos).  A full specification of the QoS framework will be given in the dedicated QoS deliverable.
