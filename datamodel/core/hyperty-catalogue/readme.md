...
| **hypertyType**           | Array of [HypertyResource.HypertyResourceType](../../data-objects/hyperty-resource) **New in Phase 2**  |      no      | It defines the type of hyperty resources handled by peers belonging to the domain served by this protostub.                                                                                                                                                                                                               |
